...
Future<void> _firebaseMessagingBackgroundHandler(RemoteMessage message) async {
  ...
  // Background/terminated: data-only FCM won't show system notification
  // unless we render a local notification ourselves.
  ...
  if (title.isNotEmpty || body.isNotEmpty) {
    await LocalNotifications.showBackgroundFCMNotification(
      title: title,
      body: body,
      imageUrl: imageUrl,
...
class LocalNotifications {
  ...
  static Future init() async {
    ...
    // Local notification objects must be initialized before showing from FCM callbacks.
  ...
  static Future<void> showBackgroundFCMNotification({
    required String title,
    required String body,
    String? imageUrl,
    String? clickAction,
