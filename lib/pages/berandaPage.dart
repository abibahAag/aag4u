...
import 'package:flutter_aag4u/pages/InfoPage.dart';
import 'package:flutter_aag4u/pages/PusatBantuanPage.dart';
import 'package:flutter_aag4u/pages/ReportOnlineWebViewPage.dart';
import 'package:flutter_aag4u/pages/TreatmentPage.dart';
...
class _berandaPage extends State<berandaPage> {
  ...
  void _openReportOnline() {
    final supportsEmbeddedWebView = !kIsWeb &&
    ...
    if (!supportsEmbeddedWebView) {
      launchUrl(
        Uri.parse('https://report.aag.co.id'),
    ...
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (_) => const ReportOnlineWebViewPage(),
      ),
    );
  }
